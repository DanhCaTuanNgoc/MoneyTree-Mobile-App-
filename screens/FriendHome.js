...
import { View, Text, RefreshControl, TouchableOpacity, ScrollView, Image, TextInput, Dimensions, Button, StatusBar } from 'react-native'
...
export default function FriendHome({ route, navigation }) {
  ...
  useEffect(() => {
    ...
    const userRef = ref(db, `users/${friendId}`) // link with the current user ID

    // Fetch user data from Firebase0
